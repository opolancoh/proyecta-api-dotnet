...
public class RiskTreatmentRepository : IRiskTreatmentRepository
{
    ...
    public RiskTreatmentRepository(ApiDbContext context, AuthDbContext authContext)
    {
        _context = context;
        _authContext = authContext;
        _entitySet = context.RiskTreatments;
    }
    ...
    public async Task<int> Create(RiskTreatment item)
    {
        _entitySet.Add(item);
        return await _context.SaveChangesAsync();
    }

    public async Task<int> Update(RiskTreatment item)
    {
